  ...
  return (
    <Card className={`p-6 ${config?.bgColor}`}>
      <div className="space-y-6">
        ...
        {/* Wallet Address */}
        <div className="bg-background dark:bg-background/50 p-4 rounded border">
        ...
        {/* Amount Details */}
        <div className="space-y-3 bg-background dark:bg-background/50 p-4 rounded border">
        ...
        {withdrawal.status === 'pending' && (
          <div className="bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 p-4 rounded flex gap-3">
        ...
        {withdrawal.status === 'approved' && (
          <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 p-4 rounded flex gap-3">
        ...
        {withdrawal.status === 'rejected' && (
          <div className="bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 p-4 rounded flex gap-3">
        ...
        {withdrawal.status === 'completed' && (
          <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 p-4 rounded flex gap-3">
