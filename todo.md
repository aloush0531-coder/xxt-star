...
## Phase 10: تحويل إلى Progressive Web App (PWA)

- [x] إضافة manifest.json مع أيقونات التطبيق
- [x] إنشاء Service Worker للعمل بدون إنترنت
- [x] تفعيل تثبيت التطبيق من المتصفح
- [x] اختبار على iOS و Android
- [x] حفظ نقطة تفتيش نهائية

## Phase 11: نظام الوصل والموافقة على طلبات السحب

- [x] إضافة عمود الرسوم (fee) لجدول withdrawals
- [x] تحديث procedures لدعم حساب الرسوم
- [x] إنشاء صفحة AdminWithdrawals لإدارة طلبات السحب
- [x] إنشاء مكون WithdrawalReceipt لعرض الوصل المفصل
- [x] تحديث صفحة Withdraw لعرض الوصل القابل للتوسع
- [x] إضافة procedures getAllWithdrawals و getDetails للمسؤول
